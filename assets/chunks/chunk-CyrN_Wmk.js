...
fn mainFragment(
  ...
  @builtin(position) position: vec4<f32>,
    ...
    return sample;
        ...
        `}};let V,E;class kt extends Q{constructor(e){const t=new P({uColor:{value:new Float32Array([1,1,1,1]),type:"vec4<f32>"},uTransformMatrix:{value:new T,type:"mat3x3<f32>"},uDistance:{value:4,type:"f32"},uRound:{value:0,type:"f32"}});V??(V=fe({name:"sdf-shader",bits:[qe,Qe(e),Mt,At,pe]})),E??(E=me({name:"sdf-shader",bits:[Ke,Je(e),Dt,zt,ge]})),super({glProgram:E,gpuProgram:V,resources:{localUniforms:t,batchSamplers:Ze(e)}})}}class It extends st{destroy(){this.context.customShader&&this.context.customShader.destroy(),super.destroy()}}class Ie{constructor(e){this._renderer=e,this._renderer.renderableGC.addManagedHash(this,"_gpuBitmapText")}validateRenderable(e){const t=this._getGpuBitmapText(e);return this._renderer.renderPipes.graphics.validateRenderable(t)}addRenderable(e,t){const r=this._getGpuBitmapText(e);ue(e,r),e._didTextUpdate&&(e._didTextUpdate=!1,this._updateContext(e,r)),this._renderer.renderPipes.graphics.addRenderable(r,t),r.context.customShader&&this._updateDistanceField(e)}updateRenderable(e){const t=this._getGpuBitmapText(e);ue(e,t),this._renderer.renderPipes.graphics.updateRenderable(t),t.context.customShader&&this._updateDistanceField(e)}_updateContext(e,t){const{context:r}=t,s=et.getFont(e.text,e._style);r.clear(),s.distanceField.type!=="none"&&(r.customShader||(r.customShader=new kt(this._renderer.limits.maxBatchableTextures)));const a=tt.graphemeSegmenter(e.text),i=e._style;let o=s.baseLineOffset;const u=rt(a,i,s,!0),l=i.padding,h=u.scale;let d=u.width,c=u.height+u.offsetY;i._stroke&&(d+=i._stroke.width/h,c+=i._stroke.width/h),r.translate(-e._anchor._x*d-l,-e._anchor._y*c-l).scale(h,h);const f=s.applyFillAsTint?i._fill.color:16777215;let x=s.fontMetrics.fontSize,g=s.lineHeight;i.lineHeight&&(x=i.fontSize/h,g=i.lineHeight/h);let m=(g-x)/2;m-s.baseLineOffset<0&&(m=0);for(let b=0;b<u.lines.length;b++){const A=u.lines[b];for(let S=0;S<A.charPositions.length;S++){const Le=A.chars[S],U=s.chars[Le];if(U?.texture){const z=U.texture;r.texture(z,f||"black",Math.round(A.charPositions[S]+U.xOffset),Math.round(o+U.yOffset+m),z.orig.width,z.orig.height)}}o+=g}}_getGpuBitmapText(e){return e._gpuData[this._renderer.uid]||this.initGpuText(e)}initGpuText(e){const t=new It;return e._gpuData[this._renderer.uid]=t,this._updateContext(e,t),t}_updateDistanceField(e){const t=this._getGpuBitmapText(e).context,r=e._style.fontFamily,s=X.get(`${r}-bitmap`),{a,b:i,c:o,d:u}=e.groupTransform,l=Math.sqrt(a*a+i*i),h=Math.sqrt(o*o+u*u),d=(Math.abs(l)+Math.abs(h))/2,c=s.baseRenderedFontSize/e._style.fontSize,f=d*s.distanceField.range*(1/c);t.customShader.resources.localUniforms.uniforms.uDistance=f}destroy(){this._renderer=null}}Ie.extension={type:[p.WebGLPipes,p.WebGPUPipes,p.CanvasPipes],name:"bitmapText"};function ue(n,e){e.groupTransform=n.groupTransform,e.groupColorAlpha=n.groupColorAlpha,e.groupColor=n.groupColor,e.groupBlendMode=n.groupBlendMode,e.globalDisplayStatus=n.globalDisplayStatus,e.groupTransform=n.groupTransform,e.localDisplayStatus=n.localDisplayStatus,e.groupAlpha=n.groupAlpha,e._roundPixels=n._roundPixels}class Ot extends _e{constructor(e){super(),this.generatingTexture=!1,this._renderer=e,e.runners.resolutionChange.add(this)}resolutionChange(){const e=this.renderable;e._autoResolution&&e.onViewUpdate()}destroy(){this._renderer.htmlText.returnTexturePromise(this.texturePromise),this.texturePromise=null,this._renderer=null}}function H(n,e){const{texture:t,bounds:r}=n,s=e._style._getFinalPadding();it(r,e._anchor,t);const a=e._anchor._x*s*2,i=e._anchor._y*s*2;r.minX-=s-a,r.minY-=s-i,r.maxX-=s-a,r.maxY-=s-i}class Oe{constructor(e){this._renderer=e}validateRenderable(e){return e._didTextUpdate}addRenderable(e,t){const r=this._getGpuText(e);e._didTextUpdate&&(this._updateGpuText(e).catch(s=>{console.error(s)}),e._didTextUpdate=!1,H(r,e)),this._renderer.renderPipes.batch.addToBatch(r,t)}updateRenderable(e){const t=this._getGpuText(e);t._batcher.updateElement(t)}async _updateGpuText(e){e._didTextUpdate=!1;const t=this._getGpuText(e);if(t.generatingTexture)return;t.texturePromise&&(this._renderer.htmlText.returnTexturePromise(t.texturePromise),t.texturePromise=null),t.generatingTexture=!0,e._resolution=e._autoResolution?this._renderer.resolution:e.resolution;const r=this._renderer.htmlText.getTexturePromise(e);t.texturePromise=r,t.texture=await r;const s=e.renderGroup||e.parentRenderGroup;s&&(s.structureDidChange=!0),t.generatingTexture=!1,H(t,e)}_getGpuText(e){return e._gpuData[this._renderer.uid]||this.initGpuText(e)}initGpuText(e){const t=new Ot(this._renderer);return t.renderable=e,t.transform=e.groupTransform,t.texture=w.EMPTY,t.bounds={minX:0,maxX:1,minY:0,maxY:0},t.roundPixels=this._renderer._roundPixels|e._roundPixels,e._resolution=e._autoResolution?this._renderer.resolution:e.resolution,e._gpuData[this._renderer.uid]=t,t}destroy(){this._renderer=null}}Oe.extension={type:[p.WebGLPipes,p.WebGPUPipes,p.CanvasPipes],name:"htmlText"};function Vt(){const{userAgent:n}=j.get().getNavigator();return/^((?!chrome|android).)*safari/i.test(n)}const Et=new ce;function Ve(n,e,t,r){const s=Et;s.minX=0,s.minY=0,s.maxX=n.width/r|0,s.maxY=n.height/r|0;const a=y.getOptimalTexture(s.width,s.height,r,!1);return a.source.uploadMethodId="image",a.source.resource=n,a.source.alphaMode="premultiply-alpha-on-upload",a.frame.width=e/r,a.frame.height=t/r,a.source.emit("update",a.source),a.updateUvs(),a}function Wt(n,e){const t=e.fontFamily,r=[],s={},a=/font-family:([^;"\s]+)/g,i=n.match(a);function o(u){s[u]||(r.push(u),s[u]=!0)}if(Array.isArray(t))for(let u=0;u<t.length;u++)o(t[u]);else o(t);i&&i.forEach(u=>{const l=u.split(":")[1].trim();o(l)});for(const u in e.tagStyles){const l=e.tagStyles[u].fontFamily;o(l)}return r}async function Yt(n){const t=await(await j.get().fetch(n)).blob(),r=new FileReader;return await new Promise((a,i)=>{r.onloadend=()=>a(r.result),r.onerror=i,r.readAsDataURL(t)})}async function Lt(n,e){const t=await Yt(e);return`@font-face {
